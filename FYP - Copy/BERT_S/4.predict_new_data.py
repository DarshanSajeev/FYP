...
# CORRECT MAPPING (Matches your Image & 1.QA_sort.py)
# 0=Flu, 1=Pregnancy, 2=Sexual Intercourse, 3=Period, 4=Exercise
label_map = {
    0: "Flu",
    1: "Pregnancy", 
...
def predict_medal_test_data():
    ...
    # 4. Load the CSV from 'Test Data' folder
    ...
    for index, row in df.iterrows():
        ...
        # --- FIX: USE DIRECT CALL INSTEAD OF ENCODE_PLUS ---
