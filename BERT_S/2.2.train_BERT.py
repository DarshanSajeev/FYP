...
def main():
    ...
    # Load preprocessed tensors (input_ids, attention_mask, labels)
    print("Loading 'triage_tensors.pt'...")
    try:
        data = torch.load('../BERT_S/triage_tensors.pt', weights_only=False)
    ...
    # Prepare 10-fold stratified cross-validation
    ...
    for fold_i, (train_idx, val_idx) in enumerate(skf.split(all_input_ids, all_labels)):
        ...
        # Build train/validation tensors and dataloaders for this fold
        ...
        # Initialize a fresh BERT model for this fold
        ...
        for epoch_i in range(EPOCHS):
            ...
            # Check for improvement and save best model for fold 0
